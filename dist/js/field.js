    ...
    computed: {
        children: function children() {
            ...
            return this.field.children.filter(function (child) {
                return child[_this.field.STATUS] !== _this.field.REMOVED;
            });
        }
    },

    methods: {
        fill: function fill(formData, parentNestedField) {
            var _this2 = this;

            this.field.children.forEach(function (child) {
                return _this2.fillChildren(child, formData, parentNestedField);
            });
        ...
        replaceIndexesInSchema: function replaceIndexesInSchema() {
            var _this3 = this;
            ...
            schema.fields.forEach(function (child) {

                if (child.schema) {
                    child.schema = _this3.replaceIndexesInSchema(child);
                }

                if (child.attribute) {
                    child.attribute = child.attribute.replace(_this3.field.INDEX, _this3.field.children.length);
                }
            });
         ...
         */
        filterUpdatedSubFields: function filterUpdatedSubFields(child) {
            var _this4 = this;

            return child.fields.filter(function (field) {
                return !field.children && (field.component === 'belongs-to-field' ? field.belongsToId != parseFloat(_this4.getFieldValue(field)) : field.value != _this4.getFieldValue(field));
            });
        },
         ...
         */
        appendToFormData: function appendToFormData(child, formData) {
            var _this5 = this;
            ...
            if (child[this.field.STATUS]) {
                ...
                if (![this.field.UNCHANGED, this.field.REMOVED].includes(child[this.field.STATUS])) {
                    child.fields.filter(function (field) {
                        return !field.children;
                    }).forEach(function (field) {
                        return formData.append(field.attribute, _this5.getFieldValue(field));
                    });
                }
            }
        },
         ...
         */
        fillChildren: function fillChildren(child, formData) {
            var parent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            ...
            if (child[this.field.STATUS] !== this.field.REMOVED) {
                child.fields.filter(function (field) {
                    ...
                    return field.fill(formData, child);
                });
    ...
    computed: {
        heading: function heading() {
            ...
            return this.field.heading.replace(/{{(.*?)}}/g, function (val, key) {
                return key === 'index' ? _this.index + 1 || '' : key === 'id' ? _this.field.resourceId || '' : _this.$parent.getFieldValue(_this.field.fields.find(function (field) {
  ...
  return _c(
    ...
    [
      ...
      _vm.showDeleteModal
        ? _c("DeleteModal", {
            attrs: {
              resourceSingularName: _vm.$parent.field.name,
              resource: _vm.field
            },
            on: {
              submit: function($event) {
                _vm.$emit("remove", _vm.field)
              },
