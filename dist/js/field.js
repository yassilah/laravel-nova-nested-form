...
Nova.booting(function (Vue, router) {
    Vue.component('form-nested-form', __webpack_require__(20));
});
...
Component.options.__file = "resources/js/components/Caret.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-72ec32b0", Component.options)
  } else {
    hotAPI.rerender("data-v-72ec32b0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-72ec32b0", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/NestedForm/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ee3540ee", Component.options)
  } else {
    hotAPI.reload("data-v-ee3540ee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NestedFieldWrapper__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NestedFieldWrapper___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__NestedFieldWrapper__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { NestedFieldWrapper: __WEBPACK_IMPORTED_MODULE_1__NestedFieldWrapper___default.a },

    computed: {
        children: function children() {
            return this.field.children.filter(function (child) {
                return child.status !== 'removed';
            });
        }
    },
    ...
    methods: {
        fill: function fill(formData) {
            var parentNestedField = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            this.field.children.forEach(function (child) {
                return child.fill(formData, parentNestedField);
            });
        },
        replaceIndexAttributeInSchema: function replaceIndexAttributeInSchema() {
            var _this = this;

            var field = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.field;

            var newSchema = JSON.parse(JSON.stringify(field.schema));

            newSchema.fields.forEach(function (subfield) {
                ...
                if (subfield.schema) {
                    subfield.schema = _this.replaceIndexAttributeInSchema(subfield);
                }
            });
...
Component.options.__file = "resources/js/components/NestedForm/NestedFieldWrapper.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65130cc9", Component.options)
  } else {
    hotAPI.reload("data-v-65130cc9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_laravel_nova__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Modals_Delete__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Modals_Delete___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Modals_Delete__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Caret__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Caret___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Caret__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { DeleteModal: __WEBPACK_IMPORTED_MODULE_1__Modals_Delete___default.a, Caret: __WEBPACK_IMPORTED_MODULE_2__Caret___default.a },
    ...
    computed: {
        heading: function heading() {
            ...
            return this.parentField.heading.replace(/{{(.*?)}}/g, function (val, key) {
                return key === 'index' ? _this.index + 1 || '' : key === 'id' ? _this.field.resourceId || '' : _this.getFieldValue(_this.field.fields.find(function (field) {
    ...
    methods: {
        ...
        getFieldValue: function getFieldValue(field) {
            if (!field) return '';else if (!field.fill) return field.value || '';
         ...
         */
        filterUpdatedSubFields: function filterUpdatedSubFields() {
            var _this2 = this;

            var field = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.field;

            return field.fields.filter(function (field) {
                return !field.children && (field.component === 'belongs-to-field' ? field.belongsToId != parseFloat(_this2.getFieldValue(field)) : field.value != _this2.getFieldValue(field));
            });
        },
         ...
         */
        appendToFormData: function appendToFormData(formData) {
            var _this3 = this;

            var prefix = this.parentField.attribute + '[' + this.index + ']';
            ...
            if (this.field.status !== 'unchanged') {
                this.field.fields.filter(function (field) {
                    return !field.children;
                }).forEach(function (field) {
                    return formData.append(field.attribute, _this3.getFieldValue(field));
                });
            }
        },
        ...
        fill: function fill(formData) {
            ...
            this.field.fields.filter(function (field) {
                ...
                return child.fill(formData, _this4.field);
            });
    ...
    [
        ...
        [
          ...
          _c("div", { staticClass: "flex justify-between items-center" }, [
            _c(
              "a",
              {
                staticClass: "cursor-pointer select-none mx-2",
            ...
            _c(
              ...
              {
                staticClass:
                  "text-2xl font-bold text-danger cursor-pointer select-none rounded-full mx-2",
                on: {
                  click: function($event) {
      ...
      _c(
        "div",
        {
          ...
          class: _vm.parentField.inline ? "flex flex-wrap" : ""
        },
        _vm._l(_vm.field.fields, function(subfield, index) {
          return _c("form-" + subfield.component, {
            ...
            tag: "component",
            class:
              _vm.parentField.inline &&
              !subfield.component.includes("nested-field")
                ? "flex-1"
                : "",
            attrs: {
              field: subfield,
              errors: _vm.errors,
              resourceName: _vm.parentField.relationship,
              resourceId: _vm.parentField.resourceId
            }
          })
        })
      ),
      ...
      _vm.showDeleteModal
        ? _c("DeleteModal", {
            attrs: {
              resourceSingularName: _vm.parentField.relationship,
              resource: _vm.field
            },
            on: {
              submit: _vm.remove,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-65130cc9", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "nested-field-container",
      class:
        _vm.field.inline || _vm.field.component.includes("nested-form")
          ? "flex-none w-full"
          : ""
    },
    [
      _vm._l(_vm.children, function(child, index) {
        return _c(
          "div",
          { key: index, class: "nested-field-" + _vm.field.type + " " + index },
          [
            _c("NestedFieldWrapper", {
              attrs: {
                field: child,
                parentField: _vm.field,
                errors: _vm.errors,
                index: index
              }
            })
      ...
      _vm._v(" "),
      _vm.field.has_many || _vm.children.length === 0
        ? _c(
            "div",
            {
              staticClass:
                "p-2 text-90 border-b border-40 flex justify-center items-center bg-30"
            },
            [
              _c(
                "button",
                {
                  staticClass:
                    "btn btn-sm text-white bg-primary-dark btn-default leading-none flex items-center",
                  attrs: { type: "button" },
                  on: {
                    click: function($event) {
                      _vm.add()
                ...
                [_vm._v("Add a new " + _vm._s(_vm.field.name))]
              )
            ]
          )
        : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ee3540ee", module.exports)
  }
}
