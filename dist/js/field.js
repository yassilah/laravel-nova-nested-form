...
Nova.booting(function (Vue, router) {
    Vue.component('form-nested-form', __webpack_require__(4));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NestedFieldWrapper__ = __webpack_require__(6);
        ...
        replaceIndexAttributeInSchema: function replaceIndexAttributeInSchema() {
            ...
            newSchema.fields.forEach(function (subfield) {
                ...
                if (subfield.attribute) {
                    subfield.attribute = subfield.attribute.replace(_this.field.INDEX, _this.field.children.length);
                }
            });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        heading: function heading() {
            ...
            return this.field.heading.replace(/{{(.*?)}}/g, function (val, key) {
  ...
  return _c(
    ...
    [
        ...
        _vm._l(_vm.field.fields, function(subfield, index) {
          return _c("form-" + subfield.component, {
            ...
            attrs: {
              field: subfield,
              errors: _vm.errors,
              "resource-name": _vm.field.viaRelationship,
              "resource-id": _vm.field.viaResourceId
            }
          })
        })
      ),
      ...
      _vm.showDeleteModal
        ? _c("DeleteModal", {
            attrs: {
              resourceSingularName: _vm.field.name,
              resource: _vm.field
            },
            on: {
              submit: _vm.remove,
